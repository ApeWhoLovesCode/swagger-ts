...
import type { PostObjectSignature } from '../models/PostObjectSignature';
...
export class OssService {
     ...
     * @param count 文件数量
     * @returns PostObjectSignature
     * @throws ApiError
     */
    public static masterGetPostObjectSignature(
        fileType: 'img' | 'vid' | 'txt' | 'oth',
        count: number,
    ): CancelablePromise<PostObjectSignature> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static privateGetPostObjectSignature(
        fileType: 'img' | 'vid' | 'txt' | 'oth',
        count: number,
    ): CancelablePromise<PostObjectSignature> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/private/oss/signature',
            query: {
                'fileType': fileType,
                'count': count,
            },
